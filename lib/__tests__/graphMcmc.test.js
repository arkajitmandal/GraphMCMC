...
describe('Monte Carlo', () => {
  it('function check', () => {
    let p = graphMcmc.monteCarlo(1.0);
    assert(p, 'Monte Carlo returned false with prob 1');
    let pn = graphMcmc.monteCarlo(0.0);
    assert(!pn, 'Monte Carlo returned true with prob 0');
  });
});
